...
export const ALL_OF_DATACITE_ID = "all-of-datacite" as const;
...
export const BRAND_URLS = {
  email: "mailto:support@datacite.org",
  blog: "https://datacite.org/blog/",
  github: "https://github.com/datacite/datacite",
  x: "https://twitter.com/datacite",
  mastodon: "https://openbiblio.social/@datacite",
  linkedin: "https://www.linkedin.com/company/datacite",
  youtube: "https://www.youtube.com/@DataCiteChannel",
};
...
export const CREATOR_FIELDS = {
  present: [
    ...
    CREATORS_NAME_TYPE,
    CREATORS_NAME_ID,
    CREATORS_NAME_ID_SCHEME,
    CREATORS_AFFILIATION,
    CREATORS_AFFILIATION_ID,
    CREATORS_AFFILIATION_ID_SCHEME,
  ],
...
export const PUBLISHER_FIELDS = {
  present: [PUBLISHER, PUBLISHER_ID, PUBLISHER_ID_SCHEME],
...
export const DESCRIPTIONS_FIELDS = {
  present: [DESCRIPTIONS, DESCRIPTIONS_TYPE],
  distribution: [DESCRIPTIONS_TYPE],
} as const;

export const TITLES_FIELDS = {
  present: [TITLES, TITLES_TYPE],
...
export const DATES_FIELDS = {
  present: [DATES, DATES_INFORMATION, DATES_TYPE],
